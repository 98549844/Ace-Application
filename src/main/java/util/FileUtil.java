...
public class FileUtil {
    ...
    static String path = "/Users/garlam/IdeaProjects/spring-boot/src/main/resources/file/";
    ...
    public static void main(String[] args) throws IOException {
        ...
        // FileUtil.filrStatus(path, fileName);

        Map<String, Object> map = fileUtil.read(p);
        System.out.println(map.get("original").toString());
    }
