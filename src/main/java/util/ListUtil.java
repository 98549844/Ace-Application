...
//        }
     ...
     * need override
     */
    public static void sortListByCollections(List<LogEnt> testList) {
        if (testList == null) {
        ...
        for (int i = 0; i < size; i++) {
            if (i % 10 != 0) {
                System.out.print(testList.get(i).getLogId() + "(" + testList.get(i).getDescription() + ")" + " ; ");
            } else {
                System.out.println();
            }
        }
        ...
        Collections.sort(testList, new Comparator<LogEnt>() {
            @Override
            public int compare(LogEnt o1, LogEnt o2) {
                int i = 0;
                if (i == 0) {
                    i = o1.getLogId().compareTo(o2.getLogId());
                }

                if (i == 0) {
                    i = o1.getAccesstime().compareTo(o2.getAccesstime());
                }
                return i;
            }
        });
